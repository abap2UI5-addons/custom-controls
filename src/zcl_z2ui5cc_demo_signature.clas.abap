...
"!
"! Start with: <em>?app_start=zcl_z2ui5cc_demo_signature</em>
"!
...
CLASS zcl_z2ui5cc_demo_signature DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_z2ui5cc_demo_signature IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    box = zcl_z2ui5cc_signature_pad=>render( view   = box
