...
"!
"! Start with: <em>?app_start=z2ui5_cl_ccont_sample_03</em>
"!
...
CLASS z2ui5_cl_ccont_sample_03 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA t_rule  TYPE z2ui5_cl_ccont_validator=>ty_t_rule.
    DATA t_error TYPE z2ui5_cl_ccont_validator=>ty_t_error.
    DATA trigger TYPE i.
...
CLASS z2ui5_cl_ccont_sample_03 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    z2ui5_cl_ccont_validator=>render(
        view      = page
