...
"!
"! Start with: <em>?app_start=z2ui5_cl_ccont_sample_07</em>
"!
...
CLASS z2ui5_cl_ccont_sample_07 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS z2ui5_cl_ccont_sample_07 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    z2ui5_cl_ccont_font_awesome=>render( page ).
  ...
  METHOD model_init.
    ...
    t_collection = VALUE #(
      ( key  = z2ui5_cl_ccont_font_awesome=>cs_collection-solid
        text = `fa-solid`   icon = `heart` )
      ( key  = z2ui5_cl_ccont_font_awesome=>cs_collection-regular
        text = `fa-regular` icon = `face-smile` )
      ( key  = z2ui5_cl_ccont_font_awesome=>cs_collection-brands
    ...
    collection = z2ui5_cl_ccont_font_awesome=>cs_collection-brands.
    icon       = t_collection[ key = collection ]-icon.
    animation  = `fa-bounce`.
    model_refresh( ).
