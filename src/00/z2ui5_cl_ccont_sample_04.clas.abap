...
"!
"! Start with: <em>?app_start=z2ui5_cl_ccont_sample_04</em>
"!
...
CLASS z2ui5_cl_ccont_sample_04 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA s_bar       TYPE z2ui5_cl_ccont_chartjs=>ty_chart.
    DATA s_line      TYPE z2ui5_cl_ccont_chartjs=>ty_chart.
    DATA s_pie       TYPE z2ui5_cl_ccont_chartjs=>ty_chart.
    DATA s_doughnut  TYPE z2ui5_cl_ccont_chartjs=>ty_chart.
    DATA s_bubble    TYPE z2ui5_cl_ccont_chartjs=>ty_chart.
    DATA s_venn      TYPE z2ui5_cl_ccont_chartjs=>ty_chart.
    DATA s_wordcloud TYPE z2ui5_cl_ccont_chartjs=>ty_chart.
...
CLASS z2ui5_cl_ccont_sample_04 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    chart( view    = row2
           title   = `venn (plugin)`
           plugins = z2ui5_cl_ccont_chartjs=>cs_plugin-venn
    ...
    chart( view    = row2
           ...
           plugins = z2ui5_cl_ccont_chartjs=>cs_plugin-wordcloud
  ...
  METHOD model_init.
    ...
    DATA ls_dataset TYPE z2ui5_cl_ccont_chartjs=>ty_dataset.
  ...
  METHOD model_update.
    ...
    FIELD-SYMBOLS <ds> TYPE z2ui5_cl_ccont_chartjs=>ty_dataset.
    ...
    DATA ls_point TYPE z2ui5_cl_ccont_chartjs=>ty_x_y_r_data.
