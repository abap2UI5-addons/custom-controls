...
"!
"! Start with: <em>?app_start=z2ui5_cl_ccont_sample_02</em>
"!
...
CLASS z2ui5_cl_ccont_sample_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA t_column TYPE z2ui5_cl_ccont_spreadsheet=>ty_t_column.
...
CLASS z2ui5_cl_ccont_sample_02 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    z2ui5_cl_ccont_spreadsheet=>render(
        view      = toolbar
        tableid   = `exportTable`
        text      = `Export`
        type      = `Emphasized`
