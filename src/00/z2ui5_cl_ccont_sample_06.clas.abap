...
"!
"! Start with: <em>?app_start=z2ui5_cl_ccont_sample_06</em>
"!
...
"! buttons.
CLASS z2ui5_cl_ccont_sample_06 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA s_tour      TYPE z2ui5_cl_ccont_driverjs=>ty_s_config.
    DATA s_highlight TYPE z2ui5_cl_ccont_driverjs=>ty_s_step.
    DATA trigger     TYPE i.
...
CLASS z2ui5_cl_ccont_sample_06 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    z2ui5_cl_ccont_driverjs=>render(
        view        = page
  ...
  METHOD on_event.
    ...
    CASE client->get( )-event.
      ...
      WHEN `TOUR`.
        mode    = z2ui5_cl_ccont_driverjs=>cs_mode-tour.
        trigger = trigger + 1.
        info    = `Tour running...`.
        client->view_model_update( ).

      WHEN `HIGHLIGHT`.
        mode    = z2ui5_cl_ccont_driverjs=>cs_mode-highlight.
        trigger = trigger + 1.
    ...
    s_tour-steps = VALUE #(
      ( element = `product`
        ...
        popover-description = `The material. Type at least three characters ` &&
                              `to get a value help.`
        popover-side        = z2ui5_cl_ccont_driverjs=>cs_side-right
        popover-align       = z2ui5_cl_ccont_driverjs=>cs_align-start )
      ( element = `quantity`
      ...
      ( element = `post`
        ...
        popover-side        = z2ui5_cl_ccont_driverjs=>cs_side-bottom
        popover-align       = z2ui5_cl_ccont_driverjs=>cs_align-start ) ).
