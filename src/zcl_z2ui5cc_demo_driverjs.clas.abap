...
"!
"! Start with: <em>?app_start=zcl_z2ui5cc_demo_driverjs</em>
"!
...
"! buttons.
CLASS zcl_z2ui5cc_demo_driverjs DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA s_tour      TYPE zcl_z2ui5cc_driverjs=>ty_s_config.
    DATA s_highlight TYPE zcl_z2ui5cc_driverjs=>ty_s_step.
    DATA trigger     TYPE i.
...
CLASS zcl_z2ui5cc_demo_driverjs IMPLEMENTATION.
  ...
  METHOD on_event.
    ...
    CASE client->get( )-event.
      ...
      WHEN `TOUR`.
        mode    = zcl_z2ui5cc_driverjs=>cs_mode-tour.
        trigger = trigger + 1.
        info    = `Tour running...`.
        client->view_model_update( ).

      WHEN `HIGHLIGHT`.
        mode    = zcl_z2ui5cc_driverjs=>cs_mode-highlight.
        trigger = trigger + 1.
    ...
    s_tour-steps = VALUE #(
      ( element = `product`
        ...
        popover-description = `The material. Type at least three characters ` &&
                              `to get a value help.`
        popover-side        = zcl_z2ui5cc_driverjs=>cs_side-right
        popover-align       = zcl_z2ui5cc_driverjs=>cs_align-start )
      ( element = `quantity`
      ...
      ( element = `post`
        ...
        popover-side        = zcl_z2ui5cc_driverjs=>cs_side-bottom
        popover-align       = zcl_z2ui5cc_driverjs=>cs_align-start ) ).
