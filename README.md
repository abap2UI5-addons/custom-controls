...
z2ui5_cl_cci=>xmlns( root ).             " declares xmlns:z2ui5cc - once per view
...
```abap
z2ui5_cl_cci_chartjs=>render( view = page config = … liburl = `/sap/bc/ui5_ui5/sap/z2ui5cc/chart.umd.js` ).
```
...
The frontend namespace is unrelated to it and stays `z2ui5cc`: it is the
resourceRoot the abap2UI5 frontend reserves, and the BSP is named after it.
