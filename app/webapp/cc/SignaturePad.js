// z2ui5cc.cc.SignaturePad - a canvas the user signs on with mouse, finger or
...
sap.ui.define(["sap/ui/core/Control"], (Control) => {
  ...
  return Control.extend("z2ui5cc.cc.SignaturePad", {
    metadata: {
      properties: {
    ...
    _attach(canvas) {
      ...
      if (canvas._z2ui5ccAttached) return;
      canvas._z2ui5ccAttached = true;
