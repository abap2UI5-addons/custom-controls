// z2ui5ccc.cc.ExportSpreadsheet - a button that exports the rows a table is
...
sap.ui.define(
  ["sap/ui/core/Control", "sap/m/Button", "z2ui5ccc/cc/Util"],
  (Control, Button, Util) => {
    "use strict";
    ...
    return Control.extend("z2ui5ccc.cc.ExportSpreadsheet", {
      metadata: {
        properties: {
