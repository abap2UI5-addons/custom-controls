// z2ui5_cci.cc.ExportSpreadsheet - a button that exports the rows a table is
...
sap.ui.define(
  ["sap/ui/core/Control", "sap/m/Button", "z2ui5_cci/cc/Util"],
  (Control, Button, Util) => {
    "use strict";
    ...
    return Control.extend("z2ui5_cci.cc.ExportSpreadsheet", {
      metadata: {
        properties: {
